            ...
            <div class="container">
                <div class="section" id="verified_merchants">
                    <div class="card col-md-12 offset-md" style="">
                        <br>
                        <h3 class="card-title text-center">"{{ strtoupper(request()->commodity) }}" products requested by buyers</h3>
                        <div class="row">
                            @if (count($buyers) > 0)
                                @foreach ($buyers as $b)
                                    <div class="col-md-3 ml-auto mr-auto">
                                        <div class="card card-pricing bg-primary">
                                            <div class="card-body" id="merchant-list" style="">
                                                ...
                                                <img src="{{ $b->photo }}" alt="Raised Image" class="img-raised rounded img-fluid">
                                                {{--  <img src="{{ asset('trading/img/products/f.jpg') }}" alt="Raised Image" class="img-raised rounded img-fluid">  --}}

                                                <h4 class="card-title">{{ ucfirst($b->commodity) }}</h4>
                                                <p class="card-description">
                                                    <i class="material-icons">money</i>&nbsp; ${{ $b->price }}/MT <br>
                                                    <i class="material-icons">location_on</i>&nbsp; {{ $b->location }}<br>
